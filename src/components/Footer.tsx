      ...
      <div className="w-full px-4 md:px-6 py-16">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex justify-center items-center gap-4 mb-16">
            ...
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/company/tachyon-community-club/"
              target="_blank"
              rel="noopener noreferrer"
              className="group"
            >
          ...
          <div className="border-t border-white/10">
            <div className="flex flex-col md:flex-row items-center justify-between text-gray-400 py-8">
              <p>© 2025 HackSprint 5.0 | <a href="https://pesce.ac.in" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">P. E. S. College of Engineering, Mandya</a></p>
